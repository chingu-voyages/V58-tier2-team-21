...
export default function Index() {
  return (
    <section className="w-full relative pt-[12vh] md:pt-[16vh] lg:pt-[4vh] overflow-hidden">
      <Container>
        <div
          className={`max-w-sm md:max-w-md lg:max-w-md mx-auto flex flex-col gap-4 items-center lg:items-start text-center lg:text-left
        ...
        >
          ...
          <p className="text-xl">
            Learn about members of the Chingu community all over the world
          </p>
          <Link
            className="mt-4 text-lg bg-secondary hover:bg-secondary-light px-10 py-2 rounded-sm"
            to="list"
          >
            Explore now
          </Link>
